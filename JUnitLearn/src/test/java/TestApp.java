...
public class TestApp {
    ...
    public void testMethodOne1() {
        Assert.assertArrayEquals(new int[]{1, 7}, app.methodOne(new int[]{1, 2, 5, 3, 4, 4, 6, 6, 4, 1, 7}));
    }

    @Test
    public void testMethodOne2() {
        Assert.assertArrayEquals(new int[]{6, 6, 1, 7}, app.methodOne(new int[]{1, 2, 5, 3, 4, 4, 6, 6, 1, 7}));
    }

    @Test(expected = RuntimeException.class)
    public void testMethodOne3() {
        Assert.assertArrayEquals(new int[]{}, app.methodOne(new int[]{1, 2, 5, 3, 6, 6, 1, 7}));
    }
